...
<script>
	function product_delete(){
		if(confirm("삭제하시겠습니까?")){
			document.form1.action = "/ex/shop/product/delete"
	...
	function product_update(){
		...
		document.form1.action = "/ex/shop/product/update";
		document.form1.submit();
	}
</script>
</head>
...
<form name = "form1" method = "post" enctype = "multipart/form-data">
	<table>
		...
		<tr>
			<td>상품이미지</td>
			<td>
				<img src = "/ex/images/${dto.filename}" width = "300px" height = "300px">
		...
		<tr>
			<td colspan = "2" align = "center">
				...
				<input type = "button" value = "목록" onclick = "location.href='/ex/shop/product/list'">
			</td>
		</tr>
	</table>
</form>
